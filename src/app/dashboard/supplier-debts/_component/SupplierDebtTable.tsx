...
interface SupplierDebtTableProps {
  debts: SupplierDebtData[];
  onView: (debt: SupplierDebtData) => void;
  onPay: (debt: SupplierDebtData) => void;
  onDelete: (debt: SupplierDebtData) => void;
}
  ...
  if (debts.length === 0) {
    return (
      <div className="glass-card p-12 text-center">
        <p className="text-gray-500">Tidak ada data utang supplier</p>
      </div>
    );
  }
              ...
              <tr key={debt.id} className="hover:bg-gray-50 transition-colors">
                ...
                <td className="px-6 py-4">
                  <div className="text-sm">
                    ...
                    <p className="text-gray-500">{debt.supplier.code}</p>
                  </div>
                </td>
                <td className="px-6 py-4 whitespace-nowrap">
