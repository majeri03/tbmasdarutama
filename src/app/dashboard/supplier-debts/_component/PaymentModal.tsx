  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (amountNum > debt.remainingDebt) {
        showToast("Jumlah pembayaran melebihi sisa utang", "error");
        setIsLoading(false);
        return;
      }
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="sticky top-0 bg-white border-b border-gray-200 px-6 py-4 flex items-center justify-between">
          <h2 className="text-xl font-bold text-gray-900">Bayar Utang Supplier</h2>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div className="glass-card p-4 space-y-2">
            ...
            <div className="flex justify-between pt-2 border-t border-gray-200">
              <span className="text-sm text-gray-600">Sisa Utang:</span>
