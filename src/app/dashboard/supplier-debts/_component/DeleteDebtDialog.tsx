...
import { deleteSupplierDebt } from "@/lib/actions/supplier-debt.actions";
...
export function DeleteDebtDialog({
  ...
  const handleDelete = async () => {
    ...
    try {
      const result = await deleteSupplierDebt(debt.id);

      if (result.success) {
        showToast(result.message || "Utang berhasil dihapus", "success");
        onSuccess();
        onClose();
      } else {
        showToast(result.error || "Gagal menghapus utang", "error");
      }
    } catch (error) {
      ...
      <div className="bg-white rounded-xl w-full max-w-md">
        ...
        <div className="border-b border-gray-200 px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-xl font-bold text-gray-900">Hapus Utang</h2>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-6 space-y-4">
          ...
          <div className="glass-card p-4 space-y-2">
            ...
            <div className="flex justify-between">
              ...
              <span className="font-semibold">{debt.purchase.poNumber}</span>
            </div>
          ...
          <div className="bg-red-50 border border-red-200 rounded-lg p-4">
            <p className="text-sm text-red-800">
              ...
              Utang akan dihapus secara permanen dari sistem.
            </p>
          </div>
